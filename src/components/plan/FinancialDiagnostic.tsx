  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="glass-card-strong p-6">
        <h3 className="text-sm font-bold uppercase tracking-wider text-muted-foreground mb-4 text-center">Score de Saúde Financeira</h3>
      ...
      <Card className="glass-card p-4 space-y-3">
        ...
        {diag.monthsToMillion && (
          <div className="text-center pt-2 border-t border-border/30">
            <p className="text-[10px] text-muted-foreground uppercase">Previsão para o milhão</p>
        ...
        <Card className="glass-card p-4 border-destructive/20">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-medium">{diag.biggestBottleneck}</p>
            </div>
          </div>
        </Card>
        <Card className="glass-card p-4 border-primary/20">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-medium">{diag.biggestOpportunity}</p>
            </div>
          </div>
        </Card>
      </div>
...
function Metric({ label, value, icon: Icon, positive }: {
  ...
  return (
    <div className="text-center p-2 rounded-lg bg-muted/30">
      <Icon className={`w-3.5 h-3.5 mx-auto mb-1 ${positive ? "text-primary" : "text-muted-foreground"}`} />
      <p className="text-[10px] text-muted-foreground uppercase">{label}</p>
      <p className={`text-sm font-bold ${positive ? "text-primary" : "text-foreground"}`}>{value}</p>
    </div>
  );
}
